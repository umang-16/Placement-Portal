...
// ✅ Logout logic with Security Headers
if(isset($_GET['confirm']) && $_GET['confirm'] === 'yes'){
    session_unset();
    session_destroy();
    
    // 🔥 CLEAR BROWSER CACHE - Back button ne rokva mate
...
<head>
<meta charset="UTF-8">
<title>Confirm Logout - Placement Portal</title>
...
<div class="box">
  ...
  <p>Are you sure you want to exit, <b style="color: #38bdf8;"><?= htmlspecialchars($student_name) ?></b>?</p>
  <div class="buttons">
    <a class="btn yes" href="student-logout.php?confirm=yes">Yes, Logout</a>
    <a class="btn no" href="dashboard.php?confirm=no">No, Stay</a>
  </div>
</div>
</body>
</html>
