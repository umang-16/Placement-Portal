...
if(!isset($_GET['token'])){
    die("<div style='text-align:center; margin-top:50px; font-family:sans-serif; background:#0a0f1a; color:#f8fafc; height:100vh; padding-top:50px;'>
            ...
            <p style='color:#94a3b8;'>The reset token is missing. Please check your email link.</p>
            <a href='forgot-password.php' style='color:#38bdf8;'>Back to Forgot Password</a>
         </div>");
}

$token = $_GET['token'];

// 🔍 1. Verify Token and Check Expiry (Using token_expire from your DB)
$check_query = "SELECT id FROM students WHERE reset_token = '$token' AND token_expire > NOW() LIMIT 1";
...
if(mysqli_num_rows($check) != 1){
    die("<div style='text-align:center; margin-top:50px; font-family:sans-serif; background:#0a0f1a; color:#f8fafc; height:100vh; padding-top:50px;'>
            ...
            <a href='forgot-password.php' style='color:#38bdf8;'>Request a new link</a>
         </div>");
}
...
if(isset($_POST['reset_pass'])){
    ...
    if($pass !== $cpass){
        ...
        mysqli_query($conn, "UPDATE students SET password='$hash', reset_token=NULL, token_expire=NULL WHERE reset_token='$token'");
...
<div class="page-container">
    <div class="box">
        ...
        <p>Set a strong password for your student account.</p>
